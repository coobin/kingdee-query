        ...
        post: {
          ...
          requestBody: { required: true, content: { "application/json": { schema: {
            ...
            properties: {
              ...
              tool: { type: "string", enum: ["inventory", "inventory_cycle", "sales_orders", "overdue_receivables", "receivable_aging", "overdue_risk_combined", "purchase_orders", "expense_claims", "workflow_progress"] },
